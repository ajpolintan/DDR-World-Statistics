...
export default function DDR_Randomizer({ svgWidth, svgHeight }: D3Props) {
  ...
  return (
    <div className='flex-col'>
      ...
      inline-flex items-center justify-center p-4 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-600 to-pink-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white " onClick={handleClick}> Randomly Pick a Song List to Play :0</button>
      <ol className='mb-4 list-decimal ml-4'>
